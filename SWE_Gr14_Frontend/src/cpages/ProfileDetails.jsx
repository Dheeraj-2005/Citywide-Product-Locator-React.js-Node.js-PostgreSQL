...
function ProfileDetails() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8000/c_add_profile", {
        // corrected endpoint
        method: "POST",
        headers: {
